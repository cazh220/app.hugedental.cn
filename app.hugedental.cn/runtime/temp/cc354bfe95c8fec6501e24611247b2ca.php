<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/app.hugedental.cn/public/../application/index/view/credits/code.html";i:1515692583;}*/ ?>
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <tbody><tr class="header" style="text-align:center"> 
    <td height="40">防伪码录入获取积分</td>
  </tr>
  <tr> 
    <td height="25" bgcolor="#FFFFFF"> <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tbody><tr> 
          <td> 
          	<form action="add_patient_techer" method="post">
          		<div align="center">请输入防伪码：<input type="text" placeholder="请输入防伪码" name="code" value="" style="height:25px; line-height: 25px;" />&nbsp;&nbsp;<input type="submit" value="确定" /> </div>
          	</form>
            </td>
        </tr>
      </tbody></table> 
