...
class User extends Model
{
	public function register($param)
	{
        ...
        $m = 'F'.$y.$m.$user_id;
      	...
      	$sql = "UPDATE hg_user SET member_id = '".$m."' WHERE user_id = ".$user_id;
	...
	{
		$res = Db::query("SELECT * FROM hg_user WHERE (mobile = :mobile OR username = :username) AND password = :password", ['mobile'=>$mobile, 'username'=>$mobile, 'password'=>$password]);
		return !empty($res) ? $res : array();
	}
