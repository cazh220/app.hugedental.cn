<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/app.hugedental.cn/public/../application/admin/view/index/login.html";i:1513001834;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>后台管理系统</title>
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="../index/doLogin" onsubmit="return check_login()">
        ...
        <input type="text" id="verify_code" name="verify_code" class="input-medium" placeholder="验证码"><img style="padding-bottom:15px" src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?x='+Math.random();" />
