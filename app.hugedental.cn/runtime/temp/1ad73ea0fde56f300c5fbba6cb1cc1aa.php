<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/app.hugedental.cn/public/../application/admin/view/user/add.html";i:1514125978;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    <title>添加新会员</title>
...
<table class="table table-bordered table-hover definewidth m10">
	...
	<tr>
		...
		<option value="<?php echo $year; ?>" <?php if($year_now == $year): ?>selected="selected"<?php endif; ?>><?php echo $year; ?></option>
...
<script>
    ...
    function save()
    {
		...
		//校验账号是否亦存在
		$.ajax({
				url:'http://app.hugedental.cn/public/admin.php/admin/user/is_exist_user',
				type:'get',
