...
class Gift 
{
	...
	public function doAdd()
	{
		...
		$validity_time = input('validity_time');
      	$stock = input('stock');
		...
		$param = array(
			...
			'validity_time'	=> $validity_time ? $validity_time." 23:59:59" : '',
			'attribute'		=> $attribute,
			'is_delete'		=> 0
		);
		$Gift = model('Gift');
		$ressult = $Gift->addGift($param);
		$url = Config::get('host_url')."/public/admin.php/admin/gift/index";
		if ($ressult == 0)
		{
	...
	public function doEdit()
	{
      	...
      	else
        {
      	...
      	//var_dump($upload);print_r($gift_photo);die;
