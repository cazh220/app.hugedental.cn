<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/app.hugedental.cn/public/../application/admin/view/gift/add.html";i:1514986563;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>添加奖品</title>
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td style="line-height:27px;">
				...
				<input type="hidden" id="dtp_input2" name="validity_time" value="" /><br/>
		</td>
    </tr>
    <tr>
    ...
    <tr>
  	...
  	<tr>
        ...
        <td ><input type="text" id="stock" name="stock" value="" placeholder="请填写库存数量"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="line-height:27px;">
          	<input type="hidden" id="h_upload" name="h_upload" value="0">
            <button id="save" type="button" class="btn btn-primary" onclick="save_gift()" type="button">保存</button> &nbsp;&nbsp;<button type="button" class="btn btn-success" name="backid" id="backid">返回列表</button>
        </td>
    </tr>
</table>
</form>
...
<script>
	function save_gift()
	{
		...
		if(stock)
		{
      	...
      	var h_upload = $("#h_upload").val();
      	if(h_upload==0)
        {
        	alert('请上传您的奖品图片（点击upload）');
			return false;
        }
