<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/app.hugedental.cn/public/../application/index/view/credits/detail.html";i:1515692594;}*/ ?>
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body leftmargin="0" topmargin="0">
		...
		<div class="wrap" style="margin-bottom:120px">
			<div style="margin:10px 0">
				<a href="<?php echo \think\Config::get('host_url'); ?>/public/index.php/index/index">首页</a>&nbsp;&gt;&nbsp;<a href="<?php echo \think\Config::get('host_url'); ?>/public/index.php/index/credits/search_credits">积分管理</a>&nbsp;&gt;&nbsp;积分明细</div>
  ...
  <tr> 
    <td height="25" bgcolor="#FFFFFF"> <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tbody><tr> 
          <td> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder" style="text-align:center">
              <tbody><tr class="header"> 
              <td width="10%"><div align="center">ID</div></td>
              <td width="30%"><div align="center">类别</div></td>
              <td width="30%"><div align="center">积分数量</div></td>
			  <td width="30%"><div align="center">时间</td>
            </tr>
			<?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
				<tr bgcolor="#FFFFFF"> 
				  <td colspan="7">尚无信息</td>
				</tr>
	...
	<div class="footer">
		...
		<div class="keep">
			<div class="wrap">
				...
				<p class="t-cen">Copyright © 2015  All Rights Reserved 京ICP备15001号</p>
			</div>
		</div>
	</div>
