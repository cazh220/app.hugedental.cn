...
class Weixin extends Controller
{
	...
	public function edit_menu()
	{
		...
		if($res)
		{
			echo "<script>alert('编辑成功');window.location.href='http://app.hugedental.cn/public/admin.php/admin/Weixin/index'</script>";
		}
		else
		{
	...
	public function create_menu()
	{
		...
		//$body = $_GET['body'];
		$url="http://app.hugedental.cn/index.php?do=wxmenu&body=$json_menu";
		$curl = curl_init();
		//设置抓取的url
